 <header class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="<?php echo e(route('index')); ?>" class="text-slate-900 text-sm font-medium">Home</a>
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="text-slate-500 hover:text-slate-900 transition-colors text-sm font-medium">Contact us</a>
            ...
            <div class="hidden peer-checked:block md:!hidden py-4 border-t border-slate-200">
                <div class="flex flex-col gap-4">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="text-slate-500 hover:text-slate-900 text-sm font-medium">Contact us</a>
    ...
    </header><?php /**PATH C:\Users\USER\Desktop\newapp\resources\views/layouts/header.blade.php ENDPATH**/ ?>