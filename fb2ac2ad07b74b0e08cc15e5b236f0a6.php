...
<?php if($assist->hasPackage('livewire/livewire') || $assist->hasPackage('inertiajs/inertia-laravel') || $assist->hasPackage('livewire/flux') || $assist->hasPackage('livewire/flux-pro')): ?>
...
<?php if($assist->hasPackage('livewire/livewire')): ?>
...
<?php endif; ?>
<?php if($assist->hasPackage('livewire/flux') || $assist->hasPackage('livewire/flux-pro')): ?>
...
<?php /**PATH C:\Users\USER\Desktop\newapp\storage\framework\views/6dc6d0aef864bb403facace5ffc97441.blade.php ENDPATH**/ ?>