...
<?php else: ?>
Fetch <?php echo e($phpunitDocs); ?> for PHPUnit options that make test runs faster.
<?php endif; ?>
...
<?php if($pest): ?>
Run ___SINGLE_BACKTICK___<?php echo e($assist->binCommand('pest --parallel')); ?>___SINGLE_BACKTICK___ to spread tests across the machine's CPU cores. Add ___SINGLE_BACKTICK___--processes=N___SINGLE_BACKTICK___ if the default count is unsuitable for the machine or CI.
<?php else: ?>
Run ___SINGLE_BACKTICK___<?php echo e($assist->artisanCommand('test --parallel')); ?>___SINGLE_BACKTICK___, which uses ParaTest, to spread tests across the machine's CPU cores. Add ___SINGLE_BACKTICK___--processes=N___SINGLE_BACKTICK___ if the default count is unsuitable for the machine or CI.
<?php endif; ?>
...
Run ___SINGLE_BACKTICK___<?php echo e($assist->binCommand('pest --parallel --tia')); ?>___SINGLE_BACKTICK___ to run only the tests that the recent changes affect. Pest replays the cached result of each other test.
...
Run ___SINGLE_BACKTICK___<?php echo e($assist->binCommand('pest --update-shards')); ?>___SINGLE_BACKTICK___ to measure the time of each test. Run ___SINGLE_BACKTICK___<?php echo e($assist->binCommand('pest --shard=1/4')); ?>___SINGLE_BACKTICK___ in each CI job, and change the first number for each job.
...
<?php if($pest): ?>
Run ___SINGLE_BACKTICK___<?php echo e($assist->binCommand('pest --profile')); ?>___SINGLE_BACKTICK___ to list the slowest tests. Start with the ten slowest tests, because the same cause often applies to the complete suite.
<?php else: ?>
Run ___SINGLE_BACKTICK___<?php echo e($assist->artisanCommand('test --profile')); ?>___SINGLE_BACKTICK___ to list the slowest tests. Start with the ten slowest tests, because the same cause often applies to the complete suite.
<?php endif; ?>
...
<?php /**PATH C:\Users\USER\Desktop\newapp\storage\framework\views/ee6053e901149d6d0878c211b63e65c6.blade.php ENDPATH**/ ?>